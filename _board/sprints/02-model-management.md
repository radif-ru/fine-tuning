...
| # | Риск | Смягчение |
|---|------|-----------|
| 1 | HF Hub недоступен ( rate limit, offline) | Кэширование моделей, fallback на локальные |
| 2 | LoRA target_modules неверные для модели | Model Registry со специфичными конфигами |
| 3 | 8-bit quantization не работает на некоторых GPU | Проверка поддержки, fallback на 16-bit |
